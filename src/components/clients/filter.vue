<template>
    <v-container class="ma-0 pa-0">
        <v-row class="py-10 px-8 mb-12">
            ...
            <v-spacer></v-spacer>
            <v-btn @click="deleteFilters" small class="elevation-0">
  ...
  export default {
    ...
    methods: {
        ...
        filter(){
            ...
            if(this.company.phases.length>0){
                count = count+1
            ...
            if(this.company.semaforo.length>0){
                count = count+1
